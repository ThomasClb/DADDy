...
SolverParameters get_SolverParameters_tbp_SUN_lt_earth_to_mars(unsigned int const& N) {
	// Solver parameters
...
void tbp_SUN_lt_earth_to_mars(int argc, char** argv) {
	...
	SolverParameters solver_parameters = get_SolverParameters_tbp_SUN_lt_earth_to_mars(N);
