...
Dynamics::Dynamics() {
	dynamic_ = dynFunction([](
		...
		SpacecraftParameters const&, SolverParameters const&) {
			return vectorDA(); });
...
Dynamics get_low_trust_2bp_SUN_dynamics() {
	dynFunction dyn([](
		...
		SolverParameters const& d) {
			return dynamic_2bp_SUN(a, b, c, d); });
	ctgFunction ctg([](
		vectorDA const& a, vectorDA const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return cost_to_go(a, b, c, d); });
	eqFunction eq([](
		vectorDA const& a, vectorDA const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return equality_constraints(a, b, c, d); });
	ineqFunction ineq([](
		vectorDA const& a, vectorDA const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return inequality_constraints_2bp_SUN(a, b, c, d); });
	tcFunction tc([](
		vectorDA const& a, vectordb const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return terminal_cost_2bp_SUN(a, b, c, d); });
	teqFunction teq([](
		vectorDA const& a, vectordb const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return terminal_equality_constraints(a, b, c, d); });
	tineqFunction tineq([](
		vectorDA const& a, vectordb const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return terminal_inequality_constraints(a, b, c, d); });
...
Dynamics get_low_trust_cr3bp_dynamics() {
	...
	ineqFunction ineq([](
		...
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return inequality_constraints_cr3bp(a, b, c, d); });
	tcFunction tc([](
		vectorDA const& a, vectordb const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
			return terminal_cost_cr3bp(a, b, c, d); });
	teqFunction teq([](
		vectorDA const& a, vectordb const& b,
		SpacecraftParameters const& c,
		SolverParameters const& d) {
